...
import com.afollestad.inlineactivityresult.internal.InlineActivityResult.Companion.FRAGMENT_TAG_PREFIX
...
import com.afollestad.inlineactivityresult.util.TestFragmentManager
import com.afollestad.inlineactivityresult.util.TestOnResult
import com.afollestad.inlineactivityresult.util.assertFragmentAdded
import com.afollestad.inlineactivityresult.util.expectThrows
...
class InlineActivityResultTest {
  ...
  @Test fun `schedule and deliver result - success`() {
    ...
    val instance = InlineActivityResult.instance()
        .apply {
          schedule(
    ...
    expectThrows(
        ...
        "There's no pending request for requestCode 12313."
    ) {
